...
namespace sys {
    namespace motioncontrol {
        ...
        typedef math::LqController<ModelDescription> MainController;

        typedef MotionControl<MainController, ControlState, MotionModel, observer::SystemState> MotionController;
    }
}
#endif
