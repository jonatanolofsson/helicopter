...
macro(executable_app)
    ...
    #target_link_libraries(${PROJECT_NAME} ${LOCAL_MODULES_LIBRARIES} ${LOCAL_MODULES_LIBRARIES} ${SHARED_MODULES_LIBRARIES} ${SHARED_MODULES_LIBRARIES} os)
    target_link_libraries(${PROJECT_NAME} ${LOCAL_MODULES_LIBRARIES} ${LOCAL_MODULES_LIBRARIES} ${SHARED_MODULES_LIBRARIES} ${SHARED_MODULES_LIBRARIES} os pthread)
endmacro()
